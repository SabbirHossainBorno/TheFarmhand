...
public class Order {
    ...
    public Order(User user, String date, Integer id, ArrayList<OrderItems> items, Double paidAmount, String orderStatus, String paymentStatus, String deliveryStatus) {
        this.user = user;
        this.date = date;
        this.id = id;
        this.items = items;
