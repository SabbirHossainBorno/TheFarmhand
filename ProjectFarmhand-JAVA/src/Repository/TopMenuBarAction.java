...
import Entity.User;
import Frame.AllOrdersView;
import Frame.LoginPage;
import Frame.NewOrderPage;
...
public class TopMenuBarAction {
    ...
    public void viewAllOrders(JFrame preFrame, User user) {
    ...
    public void logOut(JFrame preFrame) {
    ...
    public void newOrder(JFrame preFrame, User user) {
        NewOrderPage frame = new NewOrderPage(user);
        frame.setVisible(true);
        preFrame.setVisible(false);
        preFrame.dispose();
    }
